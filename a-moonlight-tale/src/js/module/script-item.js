...
(function() {
  ...
  let items = {
    mushrooms: {
      name: "Mushrooms",
      content:
        "<p>Interesting fact about those mushrooms: they have many unknown properties that Jack could probably use in his adventure. It is said that a long time ago, fungis were much bigger than they are now. Many travelers reported seeing mushrooms growing in circle formation (Fairy rings).</p>",
      image: "mushrooms.png"
    },
    mistletoe: {
      name: "Mistletoe",
  ...
  function itemCollect() {
	...
	mainContainer.innerHTML = `
		<div class="itemModal is-active" id="itemPopup">
    ...
    document
      .querySelector(".itemModal__close")
